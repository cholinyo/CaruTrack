...
def listar_solicitudes():
    ...
    return render_template('solicitudes/solicitudes.html', solicitudes=solicitudes)
...
def listar_solicitudes_denegadas():
    ...
    return render_template('solicitudes/solicitudes_denegadas.html', solicitudes=denegadas)

@solicitudes_bp.route('/solicitudes/exportar')
@login_required
